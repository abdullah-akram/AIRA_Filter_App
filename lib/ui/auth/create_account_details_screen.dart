  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: Home_AppBar(title: "Create Account"),
        body: Stack(children: [
          CustomBackground(
...
Future<void> temo_add_data(String title, String by, String likes, String views,
    String comments, String image, BuildContext c) async {
